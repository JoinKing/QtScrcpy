    ...
    , m_adbImpl(new AdbProcessImpl())
{
    ...
    connect(m_adbImpl, &AdbProcessImpl::transferProgress, this, &qsc::AdbProcess::fileTransferProgress);
    connect(m_adbImpl, &AdbProcessImpl::transferLog, this, &qsc::AdbProcess::transferLog);
}
...
QStringList AdbProcess::listDeviceFiles(const QString &serial, const QString &path)
{
    return m_adbImpl->listDeviceFiles(serial, path);
}
