...
public:
    ...
    virtual void pullFileRequest(const QString &devicePath, const QString &localPath = "") {
        Q_UNUSED(devicePath);
        Q_UNUSED(localPath);
    }
...
public:
    ...
    virtual void pullFileRequest(const QString &devicePath, const QString &localPath = "") = 0;
